...
function create_model(;
    num_particles=NUM_PARTICLES, num_types=NUM_TYPES, attraction_matrix=nothing, seed=42
)
...
@kernel function _integrate_kernel!(
    px, py, vx, vy, fx, fy, n::Int32, dt::Float32, damping::Float32, world_sz::Float32
)
